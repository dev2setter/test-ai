...
export class DatabaseRepository {
  ...
  searchSimilar(queryEmbedding: number[], limit: number = 5, useCosineSimilarity: boolean = true): DocumentWithSimilarity[] {
    try {
      ...
      const allDocs = getAllDocsWithEmbeddings.all() as Array<Document & { embedding: string }>;
